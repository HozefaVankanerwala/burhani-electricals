  ...
  return (
    <div className="relative bg-brand-50 overflow-hidden">
      <div className="absolute inset-0">
        ...
        />
        {/* Very light sky blue gradient overlay */}
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              ...
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-brand-600 hover:bg-brand-700 transition-colors shadow-lg"
            >
      ...
      {/* Decorative Wave - matched to slate-50 which is the next section color */}
